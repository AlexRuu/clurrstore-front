...
interface ProfileOrderPersonalDetailsProps {
  order: Order;
}

const ProfileOrderPersonalDetails: React.FC<
  ProfileOrderPersonalDetailsProps
> = ({ order }) => {
...
export default ProfileOrderPersonalDetails;
